...
try
{
	...
	function checkParameter($param)
	{
		...
		{
			echo "<p>Missing <code>" . $param . "</code> parameter in query string. <br>Syntax is: <code>?agreementGrantToken=<i>AGREEMENTGRANTTOKEN</i>&appSecretToken=<i>APPSECRETTOKEN</i></code></p> ";
